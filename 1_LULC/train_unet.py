# The code adopted from this Github repository: https://github.com/manideep2510/eye-in-the-sky
import PIL
...
filelist_trainx = sorted(glob.glob('image_RGB/*.tif'), key=numericalSort)
# List of file names of classified images for traininig 
filelist_trainy = sorted(glob.glob('label_5classes/*.tif'), key=numericalSort)
...
# tif = TIFF.open('image_RGB/14.tif')
# image = tif.read_image()
# crop_size = 128
#
# stride = 64
...
#
#
# tif = TIFF.open('label_5classes/14.tif')
# image = tif.read_image()
# crop_size = 128
#
# stride = 64
...
history = model.fit(trainx, trainy_hot, epochs=40, validation_data = (testx, testy_hot),batch_size=8, verbose=1)
